...
public class MultiCardinalityExample15IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_15.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-15";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_15";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample15IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-15-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_15");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_15.Root> getClazz() {
        return demo.translate.multi_cardinality.example_15.Root.class;
    }
