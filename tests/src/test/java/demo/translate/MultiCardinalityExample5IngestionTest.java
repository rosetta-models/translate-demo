...
public class MultiCardinalityExample5IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_5.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-5";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_5";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample5IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-5-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_5");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_5.Root> getClazz() {
        return demo.translate.multi_cardinality.example_5.Root.class;
    }
