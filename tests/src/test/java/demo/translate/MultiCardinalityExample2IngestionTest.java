...
public class MultiCardinalityExample2IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_2.Root> {
    ...
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_2";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample2IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-2-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_2");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_2.Root> getClazz() {
        return demo.translate.multi_cardinality.example_2.Root.class;
    }
