...
public class ConditionalSetExample13IngestionTest extends IngestionTest<demo.translate.conditional_set.example_13.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-13";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_13";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample13IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-13-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_13");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_13.Root> getClazz() {
        return demo.translate.conditional_set.example_13.Root.class;
    }
