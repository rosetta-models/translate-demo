...
public class MetaExternalReferenceExample6IngestionTest extends IngestionTest<demo.translate.meta_external_reference.example_6.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/meta-external-reference/example-6";
    private static final String INSTANCE_NAME = "target/META_EXTERNAL_REFERENCE_EXAMPLE_6";
    ...
    static void setup() {
        ...
        ClassLoader cl = MetaExternalReferenceExample6IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/meta-external-reference-example-6-ingestions.json")));
        ...
        ingestionService = factory.getService("META_EXTERNAL_REFERENCE_EXAMPLE_6");
    }

    @Override
    protected Class<demo.translate.meta_external_reference.example_6.Root> getClazz() {
        return demo.translate.meta_external_reference.example_6.Root.class;
    }
