...
public class ConditionalSetExample11IngestionTest extends IngestionTest<demo.translate.conditional_set.example_11.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-11";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_11";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample11IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-11-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_11");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_11.Root> getClazz() {
        return demo.translate.conditional_set.example_11.Root.class;
    }
