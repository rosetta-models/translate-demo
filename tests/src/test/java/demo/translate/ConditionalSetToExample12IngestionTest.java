...
public class ConditionalSetToExample12IngestionTest extends IngestionTest<demo.translate.conditional_set_to.example_12.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set-to/example-12";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_TO_EXAMPLE_12";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetToExample12IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-to-example-12-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_TO_EXAMPLE_12");
    }

    @Override
    protected Class<demo.translate.conditional_set_to.example_12.Root> getClazz() {
        return demo.translate.conditional_set_to.example_12.Root.class;
    }
