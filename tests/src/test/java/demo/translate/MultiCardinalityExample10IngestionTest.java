...
public class MultiCardinalityExample10IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_10.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-10";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_10";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample10IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-10-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_10");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_10.Root> getClazz() {
        return demo.translate.multi_cardinality.example_10.Root.class;
    }
