...
public class MetaExternalReferenceExample4IngestionTest extends IngestionTest<demo.translate.meta_external_reference.example_4.Root> {
    ...
    @Override
    protected Class<demo.translate.meta_external_reference.example_4.Root> getClazz() {
        return demo.translate.meta_external_reference.example_4.Root.class;
    }
