...
public class MultiCardinalityExample30IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_30.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-30";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_30";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample30IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-30-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_30");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_30.Root> getClazz() {
        return demo.translate.multi_cardinality.example_30.Root.class;
    }
