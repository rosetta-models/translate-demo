...
public class MappersExample6IngestionTest extends IngestionTest<demo.translate.mappers.example_6.Root> {
    ...
    @Override
    protected Class<demo.translate.mappers.example_6.Root> getClazz() {
        return demo.translate.mappers.example_6.Root.class;
    }
