...
public class MultiCardinalityExample3IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_3.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-3";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_3";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample3IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-3-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_3");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_3.Root> getClazz() {
        return demo.translate.multi_cardinality.example_3.Root.class;
    }
