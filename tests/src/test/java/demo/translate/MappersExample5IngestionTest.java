...
public class MappersExample5IngestionTest extends IngestionTest<demo.translate.mappers.example_5.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/mappers/example-5";
    private static final String INSTANCE_NAME = "target/MAPPERS_EXAMPLE_5";
    ...
    static void setup() {
        ...
        ClassLoader cl = MappersExample5IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/mappers-example-5-ingestions.json")));
        ...
        ingestionService = factory.getService("MAPPERS_EXAMPLE_5");
    }

    @Override
    protected Class<demo.translate.mappers.example_5.Root> getClazz() {
        return demo.translate.mappers.example_5.Root.class;
    }
