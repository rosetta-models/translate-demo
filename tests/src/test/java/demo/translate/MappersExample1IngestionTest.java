...
public class MappersExample1IngestionTest extends IngestionTest<demo.translate.mappers.example_1.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/mappers/example-1";
    private static final String INSTANCE_NAME = "target/MAPPERS_EXAMPLE_1";
    ...
    static void setup() {
        ...
        ClassLoader cl = MappersExample1IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/mappers-example-1-ingestions.json")));
        ...
        ingestionService = factory.getService("MAPPERS_EXAMPLE_1");
    }

    @Override
    protected Class<demo.translate.mappers.example_1.Root> getClazz() {
        return demo.translate.mappers.example_1.Root.class;
    }
