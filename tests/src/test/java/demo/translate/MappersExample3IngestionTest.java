...
public class MappersExample3IngestionTest extends IngestionTest<demo.translate.mappers.example_3.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/mappers/example-3";
    private static final String INSTANCE_NAME = "target/MAPPERS_EXAMPLE_3";
    ...
    static void setup() {
        ...
        ClassLoader cl = MappersExample3IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/mappers-example-3-ingestions.json")));
        ...
        ingestionService = factory.getService("MAPPERS_EXAMPLE_3");
    }

    @Override
    protected Class<demo.translate.mappers.example_3.Root> getClazz() {
        return demo.translate.mappers.example_3.Root.class;
    }
