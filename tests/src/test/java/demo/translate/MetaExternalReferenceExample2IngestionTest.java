...
public class MetaExternalReferenceExample2IngestionTest extends IngestionTest<demo.translate.meta_external_reference.example_2.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/meta-external-reference/example-2";
    private static final String INSTANCE_NAME = "target/META_EXTERNAL_REFERENCE_EXAMPLE_2";
    ...
    @Override
    protected Class<demo.translate.meta_external_reference.example_2.Root> getClazz() {
        return demo.translate.meta_external_reference.example_2.Root.class;
    }
