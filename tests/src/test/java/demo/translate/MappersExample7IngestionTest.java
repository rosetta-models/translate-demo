...
public class MappersExample7IngestionTest extends IngestionTest<demo.translate.mappers.example_7.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/mappers/example-7";
    private static final String INSTANCE_NAME = "target/MAPPERS_EXAMPLE_7";
    ...
    static void setup() {
        ...
        ClassLoader cl = MappersExample7IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/mappers-example-7-ingestions.json")));
        ...
        ingestionService = factory.getService("MAPPERS_EXAMPLE_7");
    }

    @Override
    protected Class<demo.translate.mappers.example_7.Root> getClazz() {
        return demo.translate.mappers.example_7.Root.class;
    }
