...
public class ConditionalSetExample6IngestionTest extends IngestionTest<demo.translate.conditional_set.example_6.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-6";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_6";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample6IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-6-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_6");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_6.Root> getClazz() {
        return demo.translate.conditional_set.example_6.Root.class;
    }
