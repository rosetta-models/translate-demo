...
public class ConditionalSetExample24IngestionTest extends IngestionTest<demo.translate.conditional_set.example_24.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-24";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_24";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample24IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-24-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_24");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_24.Root> getClazz() {
        return demo.translate.conditional_set.example_24.Root.class;
    }
