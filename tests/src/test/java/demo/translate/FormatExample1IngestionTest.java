...
public class FormatExample1IngestionTest extends IngestionTest<demo.translate.format.example_1.Root> {
    ...
    private static final String INSTANCE_NAME = "target/FORMAT_EXAMPLE_1";
    ...
    static void setup() {
        ...
        ClassLoader cl = FormatExample1IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/format-example-1-ingestions.json")));
        ...
        ingestionService = factory.getService("FORMAT_EXAMPLE_1");
    }

    @Override
    protected Class<demo.translate.format.example_1.Root> getClazz() {
        return demo.translate.format.example_1.Root.class;
    }
