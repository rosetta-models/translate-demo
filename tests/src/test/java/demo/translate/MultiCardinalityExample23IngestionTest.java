...
public class MultiCardinalityExample23IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_23.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-23";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_23";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample23IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-23-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_23");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_23.Root> getClazz() {
        return demo.translate.multi_cardinality.example_23.Root.class;
    }
