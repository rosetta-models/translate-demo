...
public class ConditionalSetToExample9IngestionTest extends IngestionTest<demo.translate.conditional_set_to.example_9.Root> {
    ...
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_TO_EXAMPLE_9";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetToExample9IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-to-example-9-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_TO_EXAMPLE_9");
    }

    @Override
    protected Class<demo.translate.conditional_set_to.example_9.Root> getClazz() {
        return demo.translate.conditional_set_to.example_9.Root.class;
    }
