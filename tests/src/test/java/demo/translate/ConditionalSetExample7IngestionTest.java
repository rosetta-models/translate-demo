...
public class ConditionalSetExample7IngestionTest extends IngestionTest<demo.translate.conditional_set.example_7.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-7";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_7";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample7IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-7-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_7");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_7.Root> getClazz() {
        return demo.translate.conditional_set.example_7.Root.class;
    }
