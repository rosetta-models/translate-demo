...
public class ConditionalSetExample12IngestionTest extends IngestionTest<demo.translate.conditional_set.example_12.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-12";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_12";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample12IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-12-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_12");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_12.Root> getClazz() {
        return demo.translate.conditional_set.example_12.Root.class;
    }
