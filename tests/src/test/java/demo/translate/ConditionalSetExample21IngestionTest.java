...
public class ConditionalSetExample21IngestionTest extends IngestionTest<demo.translate.conditional_set.example_21.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-21";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_21";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample21IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-21-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_21");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_21.Root> getClazz() {
        return demo.translate.conditional_set.example_21.Root.class;
    }
