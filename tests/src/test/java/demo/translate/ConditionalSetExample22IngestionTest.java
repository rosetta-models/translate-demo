...
public class ConditionalSetExample22IngestionTest extends IngestionTest<demo.translate.conditional_set.example_22.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-22";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_22";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample22IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-22-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_22");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_22.Root> getClazz() {
        return demo.translate.conditional_set.example_22.Root.class;
    }
