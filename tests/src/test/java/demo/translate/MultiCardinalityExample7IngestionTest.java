...
public class MultiCardinalityExample7IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_7.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-7";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_7";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample7IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-7-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_7");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_7.Root> getClazz() {
        return demo.translate.multi_cardinality.example_7.Root.class;
    }
