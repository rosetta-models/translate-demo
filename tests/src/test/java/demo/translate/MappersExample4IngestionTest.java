...
public class MappersExample4IngestionTest extends IngestionTest<demo.translate.mappers.example_4.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/mappers/example-4";
    private static final String INSTANCE_NAME = "target/MAPPERS_EXAMPLE_4";
    ...
    static void setup() {
        ...
        ClassLoader cl = MappersExample4IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/mappers-example-4-ingestions.json")));
        ...
        ingestionService = factory.getService("MAPPERS_EXAMPLE_4");
    }

    @Override
    protected Class<demo.translate.mappers.example_4.Root> getClazz() {
        return demo.translate.mappers.example_4.Root.class;
    }
