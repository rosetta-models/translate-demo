...
public class MultiCardinalityExample20IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_20.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-20";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_20";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample20IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-20-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_20");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_20.Root> getClazz() {
        return demo.translate.multi_cardinality.example_20.Root.class;
    }
