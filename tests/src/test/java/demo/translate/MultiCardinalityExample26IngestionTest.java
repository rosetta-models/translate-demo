...
public class MultiCardinalityExample26IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_26.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-26";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_26";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample26IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-26-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_26");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_26.Root> getClazz() {
        return demo.translate.multi_cardinality.example_26.Root.class;
    }
