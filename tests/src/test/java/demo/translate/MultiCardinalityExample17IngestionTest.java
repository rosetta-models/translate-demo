...
public class MultiCardinalityExample17IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_17.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-17";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_17";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample17IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-17-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_17");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_17.Root> getClazz() {
        return demo.translate.multi_cardinality.example_17.Root.class;
    }
