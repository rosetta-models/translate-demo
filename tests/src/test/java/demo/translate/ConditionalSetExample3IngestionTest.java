...
public class ConditionalSetExample3IngestionTest extends IngestionTest<demo.translate.conditional_set.example_3.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-3";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_3";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample3IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-3-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_3");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_3.Root> getClazz() {
        return demo.translate.conditional_set.example_3.Root.class;
    }
