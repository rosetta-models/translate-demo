...
public class ConditionalSetToExample5IngestionTest extends IngestionTest<demo.translate.conditional_set_to.example_5.Root> {
    ...
    @Override
    protected Class<demo.translate.conditional_set_to.example_5.Root> getClazz() {
        return demo.translate.conditional_set_to.example_5.Root.class;
    }
