...
public class MultiCardinalityExample22IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_22.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-22";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_22";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample22IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-22-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_22");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_22.Root> getClazz() {
        return demo.translate.multi_cardinality.example_22.Root.class;
    }
