...
public class MultiCardinalityExample4IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_4.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-4";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_4";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample4IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-4-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_4");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_4.Root> getClazz() {
        return demo.translate.multi_cardinality.example_4.Root.class;
    }
