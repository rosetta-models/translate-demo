...
public class ExternalSynonymExample6IngestionTest extends IngestionTest<demo.translate.external_synonym.example_6.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/external-synonym/example-6";
    private static final String INSTANCE_NAME = "target/EXTERNAL_SYNONYM_EXAMPLE_6";
    ...
    static void setup() {
        ...
        ClassLoader cl = ExternalSynonymExample6IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/external-synonym-example-6-ingestions.json")));
        ...
        ingestionService = factory.getService("EXTERNAL_SYNONYM_EXAMPLE_6");
    }

    @Override
    protected Class<demo.translate.external_synonym.example_6.Root> getClazz() {
        return demo.translate.external_synonym.example_6.Root.class;
    }
