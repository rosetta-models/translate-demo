...
public class MultiCardinalityExample28IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_28.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-28";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_28";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample28IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-28-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_28");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_28.Root> getClazz() {
        return demo.translate.multi_cardinality.example_28.Root.class;
    }
