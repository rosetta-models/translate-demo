...
public class ConditionalSetExample5IngestionTest extends IngestionTest<demo.translate.conditional_set.example_5.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-5";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_5";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample5IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-5-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_5");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_5.Root> getClazz() {
        return demo.translate.conditional_set.example_5.Root.class;
    }
