...
public class ExternalSynonymExample3IngestionTest extends IngestionTest<demo.translate.external_synonym.example_3.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/external-synonym/example-3";
    private static final String INSTANCE_NAME = "target/EXTERNAL_SYNONYM_EXAMPLE_3";
    ...
    static void setup() {
        ...
        ClassLoader cl = ExternalSynonymExample3IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/external-synonym-example-3-ingestions.json")));
        ...
        ingestionService = factory.getService("EXTERNAL_SYNONYM_EXAMPLE_3");
    }

    @Override
    protected Class<demo.translate.external_synonym.example_3.Root> getClazz() {
        return demo.translate.external_synonym.example_3.Root.class;
    }
