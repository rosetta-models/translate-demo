...
public class MultiCardinalityExample27IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_27.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-27";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_27";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample27IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-27-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_27");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_27.Root> getClazz() {
        return demo.translate.multi_cardinality.example_27.Root.class;
    }
