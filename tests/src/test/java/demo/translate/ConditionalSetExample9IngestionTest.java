...
public class ConditionalSetExample9IngestionTest extends IngestionTest<demo.translate.conditional_set.example_9.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-9";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_9";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample9IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-9-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_9");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_9.Root> getClazz() {
        return demo.translate.conditional_set.example_9.Root.class;
    }
