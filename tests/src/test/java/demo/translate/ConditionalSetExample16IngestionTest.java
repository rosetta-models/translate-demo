...
public class ConditionalSetExample16IngestionTest extends IngestionTest<demo.translate.conditional_set.example_16.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-16";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_16";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample16IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-16-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_16");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_16.Root> getClazz() {
        return demo.translate.conditional_set.example_16.Root.class;
    }
