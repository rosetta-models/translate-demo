...
public class MultiCardinalityExample25IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_25.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-25";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_25";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample25IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-25-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_25");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_25.Root> getClazz() {
        return demo.translate.multi_cardinality.example_25.Root.class;
    }
