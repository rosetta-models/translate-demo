...
public class MetaScopedReferenceExample1IngestionTest extends IngestionTest<demo.translate.meta_scoped_reference.example_1.Root> {
    ...
    private static final String INSTANCE_NAME = "target/META_SCOPED_REFERENCE_EXAMPLE_1";
    ...
    static void setup() {
        ...
        ClassLoader cl = MetaScopedReferenceExample1IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/meta-scoped-reference-example-1-ingestions.json")));
        ...
        ingestionService = factory.getService("META_SCOPED_REFERENCE_EXAMPLE_1");
    }

    @Override
    protected Class<demo.translate.meta_scoped_reference.example_1.Root> getClazz() {
        return demo.translate.meta_scoped_reference.example_1.Root.class;
    }
