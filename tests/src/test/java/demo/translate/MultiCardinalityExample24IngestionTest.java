...
public class MultiCardinalityExample24IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_24.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-24";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_24";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample24IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-24-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_24");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_24.Root> getClazz() {
        return demo.translate.multi_cardinality.example_24.Root.class;
    }
