...
public class ConditionalSetExample14IngestionTest extends IngestionTest<demo.translate.conditional_set.example_14.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-14";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_14";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample14IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-14-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_14");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_14.Root> getClazz() {
        return demo.translate.conditional_set.example_14.Root.class;
    }
