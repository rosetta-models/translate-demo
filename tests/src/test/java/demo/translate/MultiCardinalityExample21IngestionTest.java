...
public class MultiCardinalityExample21IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_21.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-21";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_21";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample21IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-21-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_21");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_21.Root> getClazz() {
        return demo.translate.multi_cardinality.example_21.Root.class;
    }
