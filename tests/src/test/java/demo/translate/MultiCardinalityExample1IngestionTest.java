...
public class MultiCardinalityExample1IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_1.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-1";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_1";
    ...
    static void setup() {
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_1");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_1.Root> getClazz() {
        return demo.translate.multi_cardinality.example_1.Root.class;
    }
