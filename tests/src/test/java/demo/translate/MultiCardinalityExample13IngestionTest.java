...
public class MultiCardinalityExample13IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_13.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-13";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_13";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample13IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-13-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_13");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_13.Root> getClazz() {
        return demo.translate.multi_cardinality.example_13.Root.class;
    }
