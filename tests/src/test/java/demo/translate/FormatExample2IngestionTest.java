...
public class FormatExample2IngestionTest extends IngestionTest<demo.translate.format.example_2.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/format/example-2";
    private static final String INSTANCE_NAME = "target/FORMAT_EXAMPLE_2";
    ...
    static void setup() {
        ...
        ClassLoader cl = FormatExample2IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/format-example-2-ingestions.json")));
        ...
        ingestionService = factory.getService("FORMAT_EXAMPLE_2");
    }

    @Override
    protected Class<demo.translate.format.example_2.Root> getClazz() {
        return demo.translate.format.example_2.Root.class;
    }
