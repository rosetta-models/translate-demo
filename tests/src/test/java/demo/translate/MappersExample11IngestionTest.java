...
public class MappersExample11IngestionTest extends IngestionTest<demo.translate.mappers.example_11.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/mappers/example-11";
    private static final String INSTANCE_NAME = "target/MAPPERS_EXAMPLE_11";
    ...
    static void setup() {
        ...
        ClassLoader cl = MappersExample11IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/mappers-example-11-ingestions.json")));
        ...
        ingestionService = factory.getService("MAPPERS_EXAMPLE_11");
    }

    @Override
    protected Class<demo.translate.mappers.example_11.Root> getClazz() {
        return demo.translate.mappers.example_11.Root.class;
    }
