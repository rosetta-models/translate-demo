...
public class ConditionalSetExample15IngestionTest extends IngestionTest<demo.translate.conditional_set.example_15.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-15";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_15";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample15IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-15-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_15");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_15.Root> getClazz() {
        return demo.translate.conditional_set.example_15.Root.class;
    }
