...
public class ConditionalSetToExample13IngestionTest extends IngestionTest<demo.translate.conditional_set_to.example_13.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set-to/example-13";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_TO_EXAMPLE_13";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetToExample13IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-to-example-13-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_TO_EXAMPLE_13");
    }

    @Override
    protected Class<demo.translate.conditional_set_to.example_13.Root> getClazz() {
        return demo.translate.conditional_set_to.example_13.Root.class;
    }
