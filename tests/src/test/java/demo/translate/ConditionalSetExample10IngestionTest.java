...
public class ConditionalSetExample10IngestionTest extends IngestionTest<demo.translate.conditional_set.example_10.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-10";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_10";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample10IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-10-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_10");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_10.Root> getClazz() {
        return demo.translate.conditional_set.example_10.Root.class;
    }
