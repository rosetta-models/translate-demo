...
public class MetaExternalReferenceExample3IngestionTest extends IngestionTest<demo.translate.meta_external_reference.example_3.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/meta-external-reference/example-3";
    private static final String INSTANCE_NAME = "target/META_EXTERNAL_REFERENCE_EXAMPLE_3";
    ...
    static void setup() {
        ...
        ClassLoader cl = MetaExternalReferenceExample3IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/meta-external-reference-example-3-ingestions.json")));
        ...
        ingestionService = factory.getService("META_EXTERNAL_REFERENCE_EXAMPLE_3");
    }

    @Override
    protected Class<demo.translate.meta_external_reference.example_3.Root> getClazz() {
        return demo.translate.meta_external_reference.example_3.Root.class;
    }
