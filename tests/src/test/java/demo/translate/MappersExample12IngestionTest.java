...
public class MappersExample12IngestionTest extends IngestionTest<demo.translate.mappers.example_12.Root> {
    ...
    @Override
    protected Class<demo.translate.mappers.example_12.Root> getClazz() {
        return demo.translate.mappers.example_12.Root.class;
    }
