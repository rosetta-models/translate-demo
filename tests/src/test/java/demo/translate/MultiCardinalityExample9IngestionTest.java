...
public class MultiCardinalityExample9IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_9.Root> {
    ...
    @Override
    protected Class<demo.translate.multi_cardinality.example_9.Root> getClazz() {
        return demo.translate.multi_cardinality.example_9.Root.class;
    }
