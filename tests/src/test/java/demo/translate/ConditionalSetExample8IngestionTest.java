...
public class ConditionalSetExample8IngestionTest extends IngestionTest<demo.translate.conditional_set.example_8.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-8";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_8";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample8IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-8-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_8");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_8.Root> getClazz() {
        return demo.translate.conditional_set.example_8.Root.class;
    }
