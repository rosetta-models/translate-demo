...
public class MultiCardinalityExample6IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_6.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/multi-cardinality/example-6";
    private static final String INSTANCE_NAME = "target/MULTI_CARDINALITY_EXAMPLE_6";
    ...
    static void setup() {
        ...
        ClassLoader cl = MultiCardinalityExample6IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/multi-cardinality-example-6-ingestions.json")));
        ...
        ingestionService = factory.getService("MULTI_CARDINALITY_EXAMPLE_6");
    }

    @Override
    protected Class<demo.translate.multi_cardinality.example_6.Root> getClazz() {
        return demo.translate.multi_cardinality.example_6.Root.class;
    }
