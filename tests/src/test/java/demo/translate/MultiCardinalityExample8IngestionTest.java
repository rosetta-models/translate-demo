...
public class MultiCardinalityExample8IngestionTest extends IngestionTest<demo.translate.multi_cardinality.example_8.Root> {
    ...
    @Override
    protected Class<demo.translate.multi_cardinality.example_8.Root> getClazz() {
        return demo.translate.multi_cardinality.example_8.Root.class;
    }
