...
public class ConditionalSetExample19IngestionTest extends IngestionTest<demo.translate.conditional_set.example_19.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/conditional-set/example-19";
    private static final String INSTANCE_NAME = "target/CONDITIONAL_SET_EXAMPLE_19";
    ...
    static void setup() {
        ...
        ClassLoader cl = ConditionalSetExample19IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/conditional-set-example-19-ingestions.json")));
        ...
        ingestionService = factory.getService("CONDITIONAL_SET_EXAMPLE_19");
    }

    @Override
    protected Class<demo.translate.conditional_set.example_19.Root> getClazz() {
        return demo.translate.conditional_set.example_19.Root.class;
    }
