...
public class SingleCardinalityExample3IngestionTest extends IngestionTest<demo.translate.single_cardinality.example_3.Root> {

    private static final String SAMPLE_FILES_DIR = "cdm-sample-files/single-cardinality/example-3";
    private static final String INSTANCE_NAME = "target/SINGLE_CARDINALITY_EXAMPLE_3";
    ...
    static void setup() {
        ...
        ClassLoader cl = SingleCardinalityExample3IngestionTest.class.getClassLoader();
        Collection<URL> ingestURLs = List.of(
                Objects.requireNonNull(cl.getResource("ingestions/single-cardinality-example-3-ingestions.json")));
        ...
        ingestionService = factory.getService("SINGLE_CARDINALITY_EXAMPLE_3");
    }

    @Override
    protected Class<demo.translate.single_cardinality.example_3.Root> getClazz() {
        return demo.translate.single_cardinality.example_3.Root.class;
    }
